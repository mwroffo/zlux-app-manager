...
export class EmbeddedBrowserProxy {
    ...
    private overrideOptions: boolean;
    private host: string;
    private port: number;
    ...
    constructor(context: any, noAuth: string , overrideOptions: object, host: string, port: number) {
...
function getEmbeddedBrowserProxy(context): Router {
